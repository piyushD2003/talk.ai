    ...
    return (
        <nav className="bg-white border-gray-200 fixed w-full z-20 top-0 start-0 dark:bg-gray-900 dark:border-gray-700">
                            ...
                            <form className="space-y-4" action="#">
                                ...
                                <div className="mt-2 text-sm">
                                                {validationStatus === "checking" && (
                                                    <span className="text-yellow-600 dark:text-yellow-400">Checking key...</span>
                                                )}
                                                {validationStatus === "valid" && (
                                                    <span className="text-green-600 dark:text-green-400">✅ Valid API Key!</span>
                                                )}
                                                {validationStatus === "invalid" && (
                                                    <span className="text-red-600 dark:text-red-400">❌ Invalid API Key!</span>
                                                )}
                                            </div>
                            </form>
                        </div>
            ...
            <div id="authentication-modal-register" tabIndex="-1" aria-hidden="true" className={`hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full backdrop-blur-sm`}>
                <div className="relative p-4 w-full max-w-[1400px] max-h-full">
                    {/* <!-- Modal content --> */}
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        {/* <!-- Modal header --> */}
                        <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                        ...
                        <div class="p-4 md:p-5">
                            <form class="space-y-4" onSubmit={handleRegistration} action="#">
                                <div class="w-full bg-gray-200 rounded-full dark:bg-gray-700">
                                    <div class="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" style={{ width: `${(currentStep / (steps.length - 1)) * 100}%` }}>{`${(currentStep / (steps.length - 1)) * 100}%`}</div>
                                </div>
                                {currentStep == 0 &&
                                    <>
                                        <div>
                                        ...
                                        <div className='flex justify-between'>
                                            <button type="button" class="w-full-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" disabled="true">Previous</button>
                                            <button type="button" class="w-full-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() => { setCurrentStep(currentStep + 1) }}>Next</button>
                                        </div>
                                    </>
                                }
                                {currentStep == 1 &&
                                    <>
                                        {/* <div class="flex items-start mb-5">
                                            ...
                                            <label for="remember" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Currently Studying</label>
                                        </div> */}
                                        <div>
                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">College Name</label>
                                            <input type="text" name="college" id="college" value={college} onChange={(e) => { setCollege(e.target.value) }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                        </div>
                                        <div>
                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Current Education</label>
                                            <input type="text" name="highestqualification" id="highestqualification" value={highestqualification} onChange={(e) => { setHighestQualification(e.target.value) }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                        </div>
                                        <div>
                                            <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Qualification Year</label>
                                            <input type="text" name="qualificationyear" id="qualificationyear" value={qualificationyear} onChange={(e) => { setQualificationYear(e.target.value) }} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" />
                                        </div>
                                        <div class="flex justify-between">
                                            <button type="button" class="w-full-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() => { setCurrentStep(currentStep - 1) }}>Previous</button>
                                            <button type="button" class="w-full-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() => { setCurrentStep(currentStep + 1) }}>Next</button>
                                        </div>
                                    ...
                                    <>
                                        <div>
                                            <div class="flex ">
                                                <div>
                                                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your Key</label>
                                                    <input type="text" name="Skey" id="Skey" value={key} onChange={(e) => { setKey(e.target.value) }} className="w-96 flex-auto bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="AIzaSyDtGMphqJpLrymEWq4XA3zSWT9i6AVLyEs" required />
                                                </div>
                                        ...
                                        <div class="flex justify-between">
                                            <button type="button" class="w-full-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={() => { setCurrentStep(currentStep - 1) }}>Previous</button>
                                            <button type="submit" class="w-full-md text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create your account</button>
                                        </div>
                                    </>
                                }
                            </form>
